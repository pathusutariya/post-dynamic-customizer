...
<div <?php pdc_esc_attr_e($atts) ?>>
	...
	<div class="title pdc-soh">
		...
		<div class="title-search">
			...
			<input data-name="search-input" type="text" placeholder="<?php _e("Enter URL", 'pdc'); ?>" autocomplete="off" />
		</div>
		
		<a data-name="clear-button" href="#" class="pdc-icon -cancel grey pdc-soh-target"></a>
	...
	<div class="canvas">
		...
		<div class="canvas-error">
			<p><strong><?php _e("Error.", 'pdc'); ?></strong> <?php _e("No embed found for the given URL.", 'pdc'); ?></p>
		</div>
...
// initialize
pdc_register_field_type( new pdc_field_oembed() );
