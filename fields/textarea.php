...
*
*  @class 		pdc_field_textarea
*  @extends		pdc_field
*  @package		ACF
*  @subpackage	Fields
*/

if( ! class_exists('pdc_field_textarea') ) :

class pdc_field_textarea extends pdc_field {
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		pdc_render_field_setting( $field, array(
			'label'			=> __('Rows','pdc'),
			'instructions'	=> __('Sets the textarea height','pdc'),
			'type'			=> 'number',
			'name'			=> 'rows',
			'placeholder'	=> 8
		));
...
// initialize
pdc_register_field_type( new pdc_field_textarea() );
