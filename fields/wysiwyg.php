...
class pdc_field_wysiwyg extends pdc_field {
	...
	*/
   	...
   	function get_toolbars() {
	   	...
	   	// WP < 4.7	
	   	} elseif( pdc_version_compare('wp', '<', '4.7') ) {
...
<script type="text/javascript">
	if( pdc ) pdc.fields.wysiwyg.toolbars = <?php echo json_encode($json); ?>;
</script>
<?php
	...
	*/
	...
	function render_field( $field ) {
		...
		?>
		<div <?php echo pdc_esc_attr($wrap); ?>>
...
// initialize
pdc_register_field_type( new pdc_field_wysiwyg() );
