...
*
*  @class 		pdc_field_email
*  @extends		pdc_field
*  @package		ACF
*  @subpackage	Fields
*/

if( ! class_exists('pdc_field_email') ) :

class pdc_field_email extends pdc_field {
...
// initialize
pdc_register_field_type( new pdc_field_email() );
