		...
		if( !empty($field_groups) ) {
			...
			if( $this->validate_page() ) {
				...
				echo '<style type="text/css">
					...
					.compat-attachment-fields > tbody > tr.pdc-field {
						margin: 0 0 15px;
					}
					
					.compat-attachment-fields > tbody > tr.pdc-field > td.pdc-label {
						margin: 0;
					}
					
					.compat-attachment-fields > tbody > tr.pdc-field > td.pdc-label label {
						margin: 0;
						padding: 0;
					}
					
					.compat-attachment-fields > tbody > tr.pdc-field > td.pdc-label p {
						margin: 0 0 3px !important;
					}
					
					.compat-attachment-fields > tbody > tr.pdc-field > td.pdc-input {
						margin: 0;
					}
