...
class pdc_form_user {
	...
	*/
	...
	function admin_enqueue_scripts() {
		...
		// actions
		add_action('pdc/input/admin_footer', array($this, 'admin_footer'), 10, 1);
	...
	*/
	...
	function render( $user_id, $user_form, $el = 'tr' ) {
		...
		foreach( $field_groups as $field_group ) {
			...
			// render fields
			pdc_render_fields( $post_id, $fields, $el, $field_group['instruction_placement'] );
...
.pdc-field input[type="password"],
.pdc-field input[type="number"],
.pdc-field input[type="search"],
.pdc-field input[type="email"],
.pdc-field input[type="url"],
.pdc-field select {
    max-width: 25em;
}
...
.pdc-field .pdc-field input[type="text"],
.pdc-field .pdc-field input[type="password"],
.pdc-field .pdc-field input[type="number"],
.pdc-field .pdc-field input[type="search"],
.pdc-field .pdc-field input[type="email"],
.pdc-field .pdc-field input[type="url"],
.pdc-field .pdc-field textarea,
.pdc-field .pdc-field select {
    max-width: none;
}
...
#registerform .pdc-field .pdc-label {
	margin-bottom: 0;
}

#registerform .pdc-field .pdc-label label {
	font-weight: normal;
	font-size: 14px;
}
...
(function($) {
	...
	if( !$spinner.exists() ) {
		...
		// create spinner (use .pdc-spinner becuase .spinner CSS not included on register page)
		$spinner = $('<span class="pdc-spinner"></span>');
