...
if( ! class_exists('pdc_settings_updates') ) :

class pdc_settings_updates {
	...
	*/
	...
	function show_notice( $message = '', $class = '' ){
		...
		if( pdc_has_done('pdc_settings_updates_notice') ) return false;
	...
	*/
	...
	function show_error( $error = '' ){
    	...
    	if( is_wp_error($error) ) {
        	...
        	$error = __('<b>Error</b>. Could not connect to update server', 'pdc') . ' <span class="description">(' . $error->get_error_message() . ')</span>';
	...
	*/
	...
	function load() {
		...
		// vars
		$info = pdc_updates()->get_plugin_info('pro');
