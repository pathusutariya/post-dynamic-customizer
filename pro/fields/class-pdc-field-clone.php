...
class pdc_field_clone extends pdc_field {
	...
	*/
	...
	function pdc_clone_clone_field( $field, $clone_field ) {
		...
		// This seems odd, however, the $clone_field is later passed into the pdc_clone_field() function
		// Do not delete! 
	...
	*/
	...
	function render_field_block( $field ) {
		...
		// html
		echo '<div class="pdc-clone-fields pdc-fields -'.$label_placement.' -border">';
...
// initialize
pdc_register_field_type( 'pdc_field_clone' );
