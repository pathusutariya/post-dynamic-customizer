  ...
  class pdc_admin {
    ...
    function admin_plugin_action_link($links) {
      $mylinks = array(
        ...
        '<a href="' . admin_url('edit.php?post_type=pdc-field-group&page=pdc-settings-tools') . '">Export Import</a>',
      );
    ...
    function admin_menu() {
      ...
      // add parent
      add_menu_page(__("Custom Fields", 'pdc'), __("Custom Fields", 'pdc'), $cap, $slug, false, 'dashicons-welcome-widgets-menus', '80.025');
