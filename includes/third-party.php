...
/*
*  PDC 3rd Party Compatibility Class
*
*  All the logic for 3rd party functionality
*
*  @class 		pdc_third_party
*  @package		PDC
*  @subpackage	Core
*/

if( ! class_exists('pdc_third_party') ) :
...
class pdc_third_party {
	...
	*/
	...
	function __construct() {
		...
		if( function_exists('espresso_version') ) {
			add_filter('pdc/get_post_types', array($this, 'ee_get_post_types'), 10, 2);
		}
	...
	*  tabify_posttypes
	*
	*  This function removes PDC post types from the tabify edit screen (post type selection sidebar)
	*
	*  @type	function
	*  @date	9/10/12
	*  @since	3.5.1
	...
	*/
	...
	function tabify_posttypes( $posttypes ) {
		...
		// unset
		unset( $posttypes['pdc-field-group'] );
		unset( $posttypes['pdc-field'] );
	...
	*/
	...
	function doing_dark_mode() {
		wp_enqueue_style('pdc-dark', pdc_get_url('assets/css/pdc-dark.css'), array(), PDC_VERSION );
	}
