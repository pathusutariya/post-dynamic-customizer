...
class PDC_Form_User {
	...
	*/
	...
	function admin_enqueue_scripts() {
		...
		if( !pdc_is_screen(array('profile', 'user', 'user-edit')) ) {
			return;
		}
	...
	*  render
	*
	*  This function will render PDC fields for a given $post_id parameter
	*
	*  @type	function
	*  @date	7/10/13
	*  @since	5.0.0
	...
	*/
	...
	function render( $args = array() ) {
		...
		if( $args['el'] == 'div') {
			$before = '<div class="pdc-user-' . $args['view'] . '-fields pdc-fields -clear">';
			$after = '</div>';
		}
		...
		foreach( $field_groups as $field_group ) {
			...
			// render
			echo $before;
			pdc_render_fields( $fields, $post_id, $args['el'], $field_group['instruction_placement'] );
			echo $after;
		}
...
// instantiate
pdc_new_instance('PDC_Form_User');
