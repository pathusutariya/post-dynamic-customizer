...
if( ! class_exists('PDC_Form_Gutenberg') ) :

class PDC_Form_Gutenberg {
	...
	*/
	...
	function admin_footer() {
		...
		?>
		<div id="pdc-form-after-title">
			<?php pdc_get_instance('PDC_Form_Post')->edit_form_after_title(); ?>
		</div>
		<?php
		
		
		// move #pdc-form-after-title
		?>
		<script type="text/javascript">
			$('#normal-sortables').before( $('#pdc-form-after-title') );
		</script>
		<?php
	}		
}

pdc_new_instance('PDC_Form_Gutenberg');
