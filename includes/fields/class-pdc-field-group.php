...
if( ! class_exists('pdc_field__group') ) :

class pdc_field__group extends pdc_field {
	...
	*/
	...
	function load_value( $value, $post_id, $field ) {
		...
		foreach( $field['sub_fields'] as $sub_field ) {
			...
			// load
			$value[ $sub_field['key'] ] = pdc_get_value( $post_id, $sub_field );
	...
	*/
	...
	function render_field_block( $field ) {
		...
		// html
		echo '<div class="pdc-fields -' . $label_placement . ' -border">';
	...
	<thead>
		...
		<?php foreach( $field['sub_fields'] as $sub_field ): 
			...
			<th <?php pdc_esc_attr_e( $atts ); ?>>
				<?php pdc_render_field_label( $sub_field ); ?>
				<?php pdc_render_field_instructions( $sub_field ); ?>
			</th>
		<?php endforeach; ?>
		</tr>
	</thead>
...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		?><tr class="pdc-field pdc-field-setting-sub_fields" data-setting="group" data-name="sub_fields">
			<td class="pdc-label">
...
// initialize
pdc_register_field_type( 'pdc_field__group' );
