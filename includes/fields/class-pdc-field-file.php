...
class pdc_field_file extends pdc_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		pdc_localize_text(array(
		   	'Select File'	=> __('Select File', 'pdc'),
			'Edit File'		=> __('Edit File', 'pdc'),
			'Update File'	=> __('Update File', 'pdc'),
	   	));
	}
	...
	*/
	...
	function render_field( $field ) {
		...
		$uploader = pdc_maybe_get($field, 'uploader', $uploader);
		...
		if( $field['value'] ) {
			...
			$attachment = pdc_get_attachment($field['value']);
			if( $attachment ) {
...
<div <?php pdc_esc_attr_e( $div ); ?>>
	...
	<div class="show-if-value file-wrap">
		...
		<div class="pdc-actions -hover">
			<?php 
			if( $uploader != 'basic' ): 
			?><a class="pdc-icon -pencil dark" data-name="edit" href="#" title="<?php _e('Edit', 'pdc'); ?>"></a><?php 
			endif;
			?><a class="pdc-icon -cancel dark" data-name="remove" href="#" title="<?php _e('Remove', 'pdc'); ?>"></a>
		</div>
	</div>
	<div class="hide-if-value">
		<?php if( $uploader == 'basic' ): ?>
			...
			<?php if( $field['value'] && !is_numeric($field['value']) ): ?>
				<div class="pdc-error-message"><p><?php echo pdc_esc_html($field['value']); ?></p></div>
			<?php endif; ?>
			
			<label class="pdc-basic-uploader">
				<?php pdc_file_input(array( 'name' => $field['name'], 'id' => $field['id'] )); ?>
			</label>
			
		<?php else: ?>
			
			<p><?php _e('No file selected','pdc'); ?> <a data-name="add" class="pdc-button button" href="#"><?php _e('Add File','pdc'); ?></a></p>
...
// initialize
pdc_register_field_type( 'pdc_field_file' );
