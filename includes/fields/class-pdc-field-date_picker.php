	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// bail ealry if no enqueue
	   	if( !pdc_get_setting('enqueue_datepicker') ) {
		   	return;
	   	}
		...
		// style
		wp_enqueue_style('pdc-datepicker', pdc_get_url('assets/inc/datepicker/jquery-ui.min.css'), array(), '1.11.4' );
	}
...
// initialize
pdc_register_field_type( 'pdc_field_date_picker' );
