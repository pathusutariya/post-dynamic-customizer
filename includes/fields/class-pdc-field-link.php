...
if( ! class_exists('pdc_field_link') ) :

class pdc_field_link extends pdc_field {
...
<div <?php pdc_esc_attr_e($div); ?>>
	...
	<div class="pdc-hidden">
		...
		<?php foreach( $link as $k => $v ): ?>
			<?php pdc_hidden_input(array( 'class' => "input-$k", 'name' => $field['name'] . "[$k]", 'value' => $v )); ?>
		<?php endforeach; ?>
	</div>
	
	<a href="#" class="button" data-name="add" target=""><?php _e('Select Link', 'pdc'); ?></a>
	...
	<div class="link-wrap">
		...
		<i class="pdc-icon -link-ext pdc-js-tooltip" title="<?php _e('Opens in a new window/tab', 'pdc'); ?>"></i><?php
		?><a class="pdc-icon -pencil -clear pdc-js-tooltip" data-name="edit" href="#" title="<?php _e('Edit', 'pdc'); ?>"></a><?php
		?><a class="pdc-icon -cancel -clear pdc-js-tooltip" data-name="remove" href="#" title="<?php _e('Remove', 'pdc'); ?>"></a>
	</div>
...
// initialize
pdc_register_field_type( 'pdc_field_link' );
