	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		pdc_localize_text(array(
		   	'Select Image'	=> __('Select Image', 'pdc'),
			'Edit Image'	=> __('Edit Image', 'pdc'),
			'Update Image'	=> __('Update Image', 'pdc'),
...
<div <?php pdc_esc_attr_e( $div ); ?>>
	...
	<div class="hide-if-value">
		...
		<?php else: ?>
			...
			<p><?php _e('No image selected','pdc'); ?> <a data-name="add" class="pdc-button button" href="#"><?php _e('Add Image','pdc'); ?></a></p>
...
<?php
	...
	*
	*  this filter allows PDC to add in extra data to an attachment JS object
...
// initialize
pdc_register_field_type( 'pdc_field_image' );
