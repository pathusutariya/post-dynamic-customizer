...
<div class="pdc-true-false">
	...
	<label>
		...
		<?php if( $switch ) echo pdc_esc_html($switch); ?>
		<?php if( $field['message'] ): ?><span class="message"><?php echo pdc_esc_html($field['message']); ?></span><?php endif; ?>
	</label>
</div>
<?php
...
// initialize
pdc_register_field_type( 'pdc_field_true_false' );
