...
class pdc_location {
	...
	*/
	...
	function __construct() {
		...
		// filters
		$this->add_filter('pdc/location/rule_match', true, array($this, 'rule_match'), 5, 3);
		$this->add_filter('pdc/location/rule_operators', true, array($this, 'rule_operators'), 5, 2);
		$this->add_filter('pdc/location/rule_values', true, array($this, 'rule_values'), 5, 2);
