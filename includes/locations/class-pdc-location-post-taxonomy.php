...
if( ! class_exists('pdc_location_post_taxonomy') ) :

class pdc_location_post_taxonomy extends pdc_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Post Taxonomy",'pdc');
		$this->category = 'post';
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		$post_terms = pdc_maybe_get( $screen, 'post_terms' );
		...
		if( $post_terms !== null ) {
			$post_terms = pdc_maybe_get( $post_terms, $term->taxonomy, array() );
...
// initialize
pdc_register_location_rule( 'pdc_location_post_taxonomy' );
