...
if( ! class_exists('pdc_location_post_type') ) :

class pdc_location_post_type extends pdc_location {
	...
	*/
	...
	function rule_values( $choices, $rule ) {
		...
		// return choices
		return pdc_get_pretty_post_types( $post_types );
...
// initialize
pdc_register_location_rule( 'pdc_location_post_type' );
