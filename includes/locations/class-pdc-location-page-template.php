...
if( ! class_exists('pdc_location_page_template') ) :

class pdc_location_page_template extends pdc_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Page Template",'pdc');
		$this->category = 'page';
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// return
		return pdc_get_location_rule('post_template')->rule_match( $result, $rule, $screen );
...
// initialize
pdc_register_location_rule( 'pdc_location_page_template' );
