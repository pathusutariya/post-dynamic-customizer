...
if( ! class_exists('pdc_location_page_type') ) :

class pdc_location_page_type extends pdc_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
        ...
        if( $rule['value'] == 'front_page') {
        	...
        	// vars
        	$page_parent = pdc_maybe_get( $screen, 'page_parent', $post->post_parent );
...
// initialize
pdc_register_location_rule( 'pdc_location_page_type' );
