...
if( ! class_exists('pdc_location_user_form') ) :

class pdc_location_user_form extends pdc_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$user_form = pdc_maybe_get( $screen, 'user_form' );
...
// initialize
pdc_register_location_rule( 'pdc_location_user_form' );
