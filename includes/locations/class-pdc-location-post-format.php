...
if( ! class_exists('pdc_location_post_format') ) :

class pdc_location_post_format extends pdc_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$post_format = pdc_maybe_get( $screen, 'post_format' );
...
// initialize
pdc_register_location_rule( 'pdc_location_post_format' );
