...
if( ! class_exists('pdc_location_nav_menu') ) :

class pdc_location_nav_menu extends pdc_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$nav_menu = pdc_maybe_get( $screen, 'nav_menu' );
...
// initialize
pdc_register_location_rule( 'pdc_location_nav_menu' );
