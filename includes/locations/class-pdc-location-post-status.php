...
if( ! class_exists('pdc_location_post_status') ) :

class pdc_location_post_status extends pdc_location {
	...
	*/
	...
	function rule_match( $result, $rule, $screen ) {
		...
		// vars
		$post_status = pdc_maybe_get( $screen, 'post_status' );
...
// initialize
pdc_register_location_rule( 'pdc_location_post_status' );
