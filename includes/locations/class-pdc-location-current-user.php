...
if( ! class_exists('pdc_location_current_user') ) :

class pdc_location_current_user extends pdc_location {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Current User",'pdc');
		$this->category = 'user';
...
// initialize
pdc_register_location_rule( 'pdc_location_current_user' );
