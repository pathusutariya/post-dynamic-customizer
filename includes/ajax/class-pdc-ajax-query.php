...
if( ! class_exists('PDC_Ajax_Query') ) :

class PDC_Ajax_Query extends PDC_Ajax {
	
	/** @var array The PDC field used for querying */
	var $field = false;
	...
	*/
	...
	function response() {
		...
		if( $this->has('field_key') ) {
			$this->field = pdc_get_field( $this->get('field_key') );
		}
