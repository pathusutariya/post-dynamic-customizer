...
if( ! class_exists('PDC_Admin_Upgrade') ) :

class PDC_Admin_Upgrade {
	...
	*/
	function admin_menu() {
		...
		if( pdc_has_upgrade() ) {
			...
			// add page
			$page = add_submenu_page('index.php', __('Upgrade Database','pdc'), __('Upgrade Database','pdc'), pdc_get_setting('capability'), 'pdc-upgrade', array($this,'admin_html') );
	...
	*/
	function network_admin_menu() {
		...
		if( $has_upgrade ) {
			...
			// add page
			$page = add_submenu_page('index.php', __('Upgrade Database','pdc'), __('Upgrade Database','pdc'), pdc_get_setting('capability'), 'pdc-upgrade-network', array($this,'network_admin_html'));
	...
	*/
	function admin_notices() {
		...
		// view
		pdc_get_view('html-notice-upgrade', $view);
	}
	...
	*/
	function network_admin_notices() {
		...
		// vars
		$view = array(
			'button_text'	=> __("Review sites & upgrade", 'pdc'),
			'button_url'	=> network_admin_url('index.php?page=pdc-upgrade-network'),
			'confirm'		=> false
		);
	...
	*/
	function admin_html() {
		pdc_get_view('html-admin-page-upgrade');
	}
	...
	*/
	function network_admin_html() {
		pdc_get_view('html-admin-page-upgrade-network');
	}
}

// instantiate
pdc_new_instance('PDC_Admin_Upgrade');
