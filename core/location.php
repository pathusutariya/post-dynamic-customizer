...
class pdc_location {
	...
	*/
	...
	function __construct() {
		...
		// Post
		add_filter( 'pdc/location/rule_match/post',				array($this, 'rule_match_post'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_type',		array($this, 'rule_match_post_type'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_template',	array($this, 'rule_match_post_template'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_category',	array($this, 'rule_match_post_taxonomy'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_format',		array($this, 'rule_match_post_format'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_status',		array($this, 'rule_match_post_status'), 10, 3 );
		add_filter( 'pdc/location/rule_match/post_taxonomy',	array($this, 'rule_match_post_taxonomy'), 10, 3 );
		
		
		// Page
		add_filter( 'pdc/location/rule_match/page',				array($this, 'rule_match_post'), 10, 3 );
		add_filter( 'pdc/location/rule_match/page_type',		array($this, 'rule_match_page_type'), 10, 3 );
		add_filter( 'pdc/location/rule_match/page_parent',		array($this, 'rule_match_page_parent'), 10, 3 );
		add_filter( 'pdc/location/rule_match/page_template',	array($this, 'rule_match_page_template'), 10, 3 );
		
		
		// User
		add_filter( 'pdc/location/rule_match/current_user',		array($this, 'rule_match_current_user'), 10, 3 );
		add_filter( 'pdc/location/rule_match/current_user_role',	array($this, 'rule_match_current_user_role'), 10, 3 );
		add_filter( 'pdc/location/rule_match/user_form',		array($this, 'rule_match_user_form'), 10, 3 );
		add_filter( 'pdc/location/rule_match/user_role',		array($this, 'rule_match_user_role'), 10, 3 );
		
		
		// Form
		add_filter( 'pdc/location/rule_match/taxonomy',			array($this, 'rule_match_taxonomy'), 10, 3 );
		add_filter( 'pdc/location/rule_match/attachment',		array($this, 'rule_match_attachment'), 10, 3 );
		add_filter( 'pdc/location/rule_match/comment',			array($this, 'rule_match_comment'), 10, 3 );
		add_filter( 'pdc/location/rule_match/widget',			array($this, 'rule_match_widget'), 10, 3 );
	...
	*/
	...
	function get_post_type( $options ) {
		...
		// check options
		// - allow pdc_form() to exclude the post_id param and still work as expected
	...
	*/
	...
	function rule_match_post_taxonomy( $match, $rule, $options ) {
		...
		$data = pdc_decode_taxonomy_term( $rule['value'] );
...
/*
*  pdc_get_field_group_visibility
*
...
function pdc_get_field_group_visibility( $field_group, $args = array() ) {
	...
	// vars
	$visibility = false;
	$args = pdc_parse_args($args, array(
		'post_id'		=> 0,
		'post_type'		=> 0,
		'page_template'	=> 0,
		'page_parent'	=> 0,
	...
	$args = apply_filters('pdc/location/screen', $args, $field_group);
	...
	foreach( $field_group['location'] as $group_id => $group ) {
		...
		if( !empty($group) ) {
			...
			foreach( $group as $rule_id => $rule ) {
				...
				$match = apply_filters( 'pdc/location/rule_match/' . $rule['param'] , false, $rule, $args );
